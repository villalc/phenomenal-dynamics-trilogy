...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\columnwidth]{figure2_hysteresis.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\columnwidth]{figure3_asymmetry.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\columnwidth]{figure4_transcendence.pdf}
...
Code and experimental logs: \href{https://github.com/villalc/phenomenal-dynamics-trilogy}{GitHub Repository}
